...
export const useLessonStore = create((set) => ({
  yearlyLessons: [],
  allLessons: [],
  allerleiLessons: [],  // Neu: State für neue Collection
  ...
  setAllerleiLessons: (lessons) => set({ allerleiLessons: lessons }),  // Neu
  ...
  updateAllerleiLesson: (id, updates) => set((state) => ({  // Neu
  ...
  addAllerleiLesson: (lesson) => set((state) => ({ allerleiLessons: [...state.allerleiLessons, lesson] })),  // Neu
  ...
  removeAllerleiLesson: (id) => set((state) => ({ allerleiLessons: state.allerleiLessons.filter(l => l.id !== id) })),  // Neu
  optimisticUpdateYearlyLessons: (updatedLesson, isNew = false, isDelete = false) => set((state) => {
    if (!updatedLesson) {
      ...
      return state; // Keine Änderung, wenn updatedLesson ungültig
    }
  ...
  optimisticUpdateAllerleiLessons: (updatedLesson, isNew = false, isDelete = false) => set((state) => {  // Neu
...
export const useAllerleiLessons = () => useLessonStore((state) => state.allerleiLessons, shallow);  // Neu