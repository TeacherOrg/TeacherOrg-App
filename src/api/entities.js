...
UeberfachlichKompetenz.collection = pb.collection('ueberfachliche_kompetenzen');// Generiert 'ueberfachliche_kompetenzs' – passe bei Bedarf in PocketBase zu diesem Namen um, oder erweitere die Logic
