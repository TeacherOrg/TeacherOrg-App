 ...
 */
export function Asteroid({ size = 60, children, className = '' }) {
  return (
    <div
      ...
      <div
        ...
        style={{
          background: `
            ...
            radial-gradient(circle at 70% 60%, rgba(0,0,0,0.3) 0%, transparent 40%)
          `,
 ...
 */
export function RocketProgress({ progress = 0, maxProgress = 6, label }) {
  const progressPercent = Math.min((progress / maxProgress) * 100, 100);

  return (
    <div className="rocket-container">
      {/* Progress track */}
      <div className="absolute left-1/2 bottom-0 top-10 w-2 -translate-x-1/2">
      ...
      {/* Rocket */}
      <div
        className="rocket absolute left-1/2 -translate-x-1/2 transition-all duration-1000"
